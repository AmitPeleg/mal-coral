...
def transfer_mask_based_on_orientation(im_mask, orientation):
    if orientation == 1:
        return im_mask
    elif orientation == 6:
...
def load_detectron2_dataset(labels, ontology, thing_classes, dir, existing_json_path=None):
        ...
        try:
            ...
            for i, instance in enumerate(label['Label']['objects'][::-1]):
                ...
                if MODE == 'segmentation-rle':
                    ...
                    im_mask = transfer_mask_based_on_orientation(im_mask, orientation)
